...
describe('Get Player Enum Fuction', () => {
  ...
  it('should get LeagueStatus', async () => {
    ...
    await expect(getSpy).toHaveBeenCalledWith('/api/v1/player/enum-map?enumType=LeagueStatus');
  });
  ...
  it('should get PlayerStatus', async () => {
    ...
    await expect(getSpy).toHaveBeenCalledWith('/api/v1/player/enum-map?enumType=PlayerStatus');
  });
  ...
  it('should get PlayerType', async () => {
    ...
    await expect(getSpy).toHaveBeenCalledWith('/api/v1/player/enum-map?enumType=PlayerType');
  });
  ...
  it('should get StatsType', async () => {
    ...
    await expect(getSpy).toHaveBeenCalledWith('/api/v1/player/enum-map?enumType=StatsType');
  });
