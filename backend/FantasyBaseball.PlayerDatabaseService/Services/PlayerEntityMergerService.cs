...
namespace FantasyBaseball.PlayerDatabaseService.Services
{
    ...
    public class PlayerEntityMergerService : IPlayerEntityMergerService
    {
        ...
        private static void MergeBattingStats(BaseballPlayer player, PlayerEntity entity) => player.BattingStats.ForEach(s => MergeBattingStats(s, entity));
        ...
        private static void MergeBattingStats(BattingStats stats, PlayerEntity entity) 
        {
            var statsEntity = entity.BattingStats.FirstOrDefault(s => s.StatsType == stats.StatsType);
        ...
        private static void MergePitchingStats(BaseballPlayer player, PlayerEntity entity) => player.PitchingStats.ForEach(s => MergePitchingStats(s, entity));
        ...
        private static void MergePitchingStats(PitchingStats stats, PlayerEntity entity) 
        {
            var statsEntity = entity.PitchingStats.FirstOrDefault(s => s.StatsType == stats.StatsType);
